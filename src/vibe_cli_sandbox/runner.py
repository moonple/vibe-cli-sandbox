...
def run_task(config: TaskConfig) -> TaskResult:
    ...
    result = TaskResult(
        ...
        risks=["Mock implementation: changes/diff are simulated and not applied to repo."],
        fallback=["If the output is not useful, simplify the task or provide more context."],
    )
